...
_: {
  den.aspects.gui.niri.config.provides.ksakura.homeManager = { pkgs, lib, ... }: {
    programs.niri.settings =
      ...
      # https://niri-wm.github.io/niri/Configuration:-Introduction
      {
        ...
        outputs."eDP-1" = {
          ...
          # mode = "1920x1080@120.30"; # it shouldnt be string but idc
          # You can use integer or fractional scale, for example use 1.5 for 150% scale.
          scale = 1.2;
          # Transform allows to rotate the output counter-clockwise, valid values are:
          # normal, 90, 180, 270, flipped, flipped-90, flipped-180 and flipped-270.
          # transform = "normal"; # it shouldnt be string, but idc
        ...
        # spawn-sh-at-startup = [ { command = [ "qs -c ~/source/qs/MyAwesomeShell" ]; } ];
        ...
        binds = lib.attrsets.mergeAttrsList [
          ...
          }
          {
            ...
            "Mod+D" = {
              action.spawn = lib.getExe pkgs.cosmic-launcher;
              hotkey-overlay.title = "Run an Application: Cosmic Launcher";
            };
            "Mod+Shift+D" = {
              action.spawn = lib.getExe pkgs.cosmic-applibrary;
              hotkey-overlay.title = "Open Application Launcher: Cosmic App Library";
            };
            # TODO(kat: 2026-06-16): find out how to change this to lock screen
            # "Mod+Esc" = {
            #   action.spawn         = lib.getExe pkgs.cosmic-greeter;
            #   hotkey-overlay.title = "Lock Screen";
            # };
            # TODO(kat: 2026-06-16): find out how to change this to log out
            # "Mod+Shift+Esc" = {
            #   action.spawn         = lib.getExe pkgs.cosmic-greeter;
          ...
          }
          {
            ...
            "Mod+Comma".hotkey-overlay.title =
              "Consume one window from the right to the bottom of the focused column";
            # Expel the bottom window from the focused column to the right.
            "Mod+Period".action.expel-window-from-column = { };
            "Mod+Period".hotkey-overlay.title = "Expel the bottom window from the focused column to the right";
          }
          {
